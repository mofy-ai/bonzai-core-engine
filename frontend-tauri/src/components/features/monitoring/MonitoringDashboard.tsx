// 💜 MAMA BEAR'S FAMILY MONITORING DASHBOARD - ENTERPRISE GRADE! 📊
import React from 'react';
import { motion } from 'framer-motion';
import { X, Monitor, Activity, Zap } from 'lucide-react';
...
export const MonitoringDashboard: React.FC<MonitoringDashboardProps> = ({ 
  ...
  return (
    <motion.div 
      className={cn(
        "fixed inset-0 z-50 flex items-center justify-center bg-purple-900/80 backdrop-blur-md",
        className
      )}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
